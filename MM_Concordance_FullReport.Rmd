...
Analysis sets: (i) Primary (MRD and PET/CT assessed at the same time point); (ii) Strict (Δ ≤ 30 days between MRD and PET/CT); (iii) Sensitivity (including reconstructed rows and prespecified exclusions).
