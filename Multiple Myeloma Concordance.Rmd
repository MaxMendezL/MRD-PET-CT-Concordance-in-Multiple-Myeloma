...
Transparent, fully reproducible rebuild of the MRD–PET/CT agreement and prognosis analysis using paired 2×2 data from published studies in multiple myeloma. All inputs are harmonised to canonical cell counts (a = MRD−/PET–CT+, b = MRD−/PET–CT−, c = MRD+/PET–CT−, d = MRD+/PET–CT+) with percentages back-calculated to counts by proportional allocation and reconciled to the reported cohort size (n), where needed.
